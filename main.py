...
print("|                  REEL-MAKER                   |")
print("+-----------------------------------------------+")
f_msg = input("\033[33mENTER THE TOPIC : ")
...
print("\033[4;2H[+] VOICE GENERATING...")
v_engine(
    script,
    audio_path
)
print("\033[5;2H[+] VOICE GENERATION COMPLETE...")
print("\033[6;2H[+] VIDEO GENRATION STRATED...")
...
print("\033[7;2H[+] VIDEO GENERATION COMPLETE...")
data = users[0]
print(f"\033[8;2H[+] UPLOADING ON INSTAGRAM [{data['user']}]")
snd(data["user"],data["pass"],caption,video_path)
print(f"\033[9;2H[+]VIDEO UPLOADED AT [{data['user']}]")